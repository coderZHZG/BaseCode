	...
	<body class="">
		...
		<header id="header">
			...
			<#--<div class="project-context hidden-xs">
				...
				<!-- Suggestion: populate this list with fetch and push technique &ndash;&gt;
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="img/avatars/sunny.png" alt="John Doe1111" class="online" />
						</a>
		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					<li class="">
						<a href="/main" title="主页"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">主页</span></a>
					</li>

					<#list menus as menu>
						<li>
							<a href="#"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> <span class="menu-item-parent">${menu.text}</span></a>
...
!								</ul>
					...
					<li>
						...
						<ul>
							...
							<li>
								<a href="ajax/datatables.html">Data Tables <span class="badge inbox-badge bg-color-greenLight">v1.10.6</span></a>
							</li>
							<li>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<span class="ribbon-button-alignment"> 
					<span id="refresh" class="btn btn-ribbon" data-action="resetWidgets" data-title="refresh" rel="tooltip" data-placement="bottom" data-original-title="<i class='text-warning fa fa-warning'></i> Warning! This will reset all your widget settings." data-html="true" data-reset-msg="您确定需要重置所有界面吗"><i class="fa fa-refresh"></i></span> 
				</span>
