...
<html <#--lang="en-us"--> id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">需要一个账户?</span> <a href="register.html" class="btn btn-danger">注册</a> </span>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big">Mydmin</h1>
						<div class="hero">

							<div class="pull-left login-desc-box-l">
								<h4 class="paragraph-header">个性化后台管理页面，支持移动端查看。</h4>
								...
								<fieldset>
									...
									<section>
										...
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="account" name="username">
